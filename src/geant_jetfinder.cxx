...
int main( int argc, char** argv) {
  ...
  std::string corrOutFile =  "geantjetfile.root";           // histograms will be saved here
  std::string treeOutFile = "geantjettree.root";               // jets will be saved in a TTree here
  ...
  if ( argc == 7 ) {
    ...
    corrOutFile = arguments[3];
    treeOutFile = arguments[4];
    inputFile = arguments[5];
  }
  else if ( argc ==  3 ){
    std::vector<std::string> arguments( argv+1, argv+argc );
